//! Pure, deterministic SHA-256 implementation without external dependencies.
//!
//! Conforms to FIPS 180-4. Used for deterministic state hashing.
...
impl Sha256 {
    ...
    pub fn update(&mut self, data: &[u8]) {
        ...
        while offset < data.len() {
            let to_copy = (64 - self.buffer_len).min(data.len() - offset);
