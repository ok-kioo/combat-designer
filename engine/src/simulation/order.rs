...
pub struct FrameExecutionContext<'a> {
    ...
    pub attacks: &'a BTreeMap<String, crate::domain::Attack>,
...
impl<'a> FrameExecutionContext<'a> {
    pub fn new(
        ...
        attacks: &'a BTreeMap<String, crate::domain::Attack>,
                    ...
                    if actor.can_act() {
                        ...
                        for cost in &attack.resource_costs {
                            let res_name = match cost.resource_type {
                                crate::domain::ResourceType::Stamina => "stamina",
                                crate::domain::ResourceType::Mana => "mana",
                                crate::domain::ResourceType::Meter => "meter",
                                crate::domain::ResourceType::Health => "health",
                                crate::domain::ResourceType::Custom(ref s) => s.as_str(),
                            };
